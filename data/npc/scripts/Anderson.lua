...
addTravelKeyword('vega', 'to Vega for |TRAVELCOST| gold?', 10, Position(32020, 31692, 7))
addTravelKeyword('folda', 'to Folda for |TRAVELCOST| gold?', 10, Position(32046, 31578, 7))
