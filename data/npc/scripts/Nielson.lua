...
local function addTravelKeyword(keyword, cost, destination)
	local travelKeyword = keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to sail to ' .. titleCase(keyword) .. ' for |TRAVELCOST| gold?', cost = cost, discount = 'postman'})
