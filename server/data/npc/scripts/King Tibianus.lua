...
local function creatureSayCallback(cid, type, msg)
	...
	elseif (msgcontains(msg, "yes")) and npcHandler.topic[cid] == 3 then
		...
		if player:getStorageValue(Storage.OutfitQuest.GoldenBaseOutfit) < 1 and npcHandler.topic[cid] == 5 and (msgcontains(msg, "yes")) then
			if player:getMoney() + player:getBankBalance() >= 500000 then
				...
				player:removeTotalMoney(500000)
		...
		elseif (msgcontains(msg, "yes")) and npcHandler.topic[cid] == 6 and player:getStorageValue(Storage.OutfitQuest.GoldenFirstAddon) < 1 then
			if player:getMoney() + player:getBankBalance() >= 250000 and player:getStorageValue(Storage.OutfitQuest.GoldenBaseOutfit) == 1 then
				...
				player:removeTotalMoney(250000)
		...
		elseif npcHandler.topic[cid] == 7 and (msgcontains(msg, "yes")) then
			if player:getMoney() + player:getBankBalance() >= 250000 and player:getStorageValue(Storage.OutfitQuest.GoldenBaseOutfit) == 1  and player:getStorageValue(Storage.OutfitQuest.GoldenSecondAddon) < 1 then
	...
	if msgcontains(msg, "armor") and npcHandler.topic[cid] == 2 and player:getStorageValue(Storage.OutfitQuest.GoldenBaseOutfit) < 1 then
		npcHandler:say("So you wold like to donate 500.000 gold pieces which in return will entitle you to wear a unique armor?", cid)
