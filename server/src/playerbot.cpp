...
namespace {
	...
	constexpr uint8_t rewardContainerIdBase = 2;
	constexpr uint8_t maximumContainerId = 0x0F;
	...
	constexpr std::chrono::minutes navigationOscillationSuppression(2);
	...
	constexpr int32_t economicPickupBaseUtility = 250;
